...
# - Si el número es divisible por 5, mostrar dicho número en pantalla (¡recuerda que aquí puedes utilizar la operación módulo dividiendo por 5 y 
#verificando el resto!)

# - Si el número no es divisible por 5, continuar ejecutando el loop sin mostrar el valor en pantalla (no te olvides de seguir restando para que el 
#programa no corra infinitamente).
numero = 50
if numero % 5 == 0:
    print(numero)
else:
...
for cuadrado in list(range(1, 16)):
    cuadrado = cuadrado ** 2
...
python = "python"
for indice, elemento in enumerate(python):
    lista_indices = list((indice, elemento))
    print(lista_indices)
