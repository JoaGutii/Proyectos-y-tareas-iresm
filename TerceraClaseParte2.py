...
mi_lista = ["hola", "mundo", "23", "true", "false"]
print(mi_lista)
# Práctica Listas 2
...
# nombre: Karen # apellido: Jurgens # edad: 35 # ocupacion: Periodista # Los nombres de las claves y valores deben ser iguales a la consigna.
...
mmi_dic = {"nombre":"Karen","apellido":"Jurgens","edad":"35","ocupacion":"periodista"}
mmi_dic["edad"] = ["36"]
mmi_dic["ocupacion"] = ["Editora"]
mmi_dic["pais"] = "colombia"
print (mmi_dic)
#mmi_dic ["pais"]= "colombia"
##print(mmi_dic)
