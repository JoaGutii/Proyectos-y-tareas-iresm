...
for paises,capitales in Paises_Capitales:
...
nombre_minimo = min(diccionario_edades, key=diccionario_edades.get)
edad_minima = diccionario_edades[nombre_minimo]
print(edad_minima)

                #for values in min(diccionario_edades):
                #    valor_minimo = values
                #print(valor_minimo)
